  ...
  */
  ...
  function animalNames(displayNames){
   ...
   for(let i = 0; i < displayNames.length; i++) {
        ...
        element={};
        element.animal_name=displayNames[i].animal_name;
        element.scientific_name=displayNames[i].scientific_name;
...
console.log(animalNames(zooAnimals)); 
  ...
  */
  ...
  function lowerCaseNames(displayNames){
    var finalobj=[];
    var element={};
   for(let i = 0; i < displayNames.length; i++) {
    ...
    element={};
        ...
        finalobj.push(element.animal_name.toLowerCase());
  }
  ...
  */
  ...
  function lowPopulationAnimals(lowPopulation){
    let animalZoo = lowPopulation.filter(function (e) {
...
console.log(lowPopulationAnimals(zooAnimals))
  ...
  */
  ...
  function USApop(displayNames){
    let reduced = displayNames
